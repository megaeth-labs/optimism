	...
	case engine.ForkchoiceUpdateEvent:
		if x.UnsafeL2Head.Number > lastBlock {
			...
			for {
				...
				//st.log.Info("MEGAETH", "blockNumber", x.UnsafeL2Head.Number, "blockInterval", blockInterval,
				//"averageTPS", averageTPS, "blockTxs", blockTxs, "totalTxs", totalTxs, "timeNow", now)
				break
			}
		}
